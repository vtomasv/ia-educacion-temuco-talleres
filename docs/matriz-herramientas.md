...
| Brisk Teaching | F1 / comparación | Flujo en navegador/extensión | Free Forever y Premium institucional | Permisos de extensión y cuenta | Profundización |
| MagicSchool | F1 / comparación | Catálogo docente | Plan individual y planes institucionales | Datos, cuenta y no sustitución de criterio | Profundización |
| OpenMAIC | Demo guiada | Aula multiagente, PBL y simulación | MIT en repositorio; costos externos posibles | APIs, agentes, persistencia y gobernanza | Demo preparada |
