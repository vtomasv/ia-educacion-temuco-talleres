...
3. Un prompt útil suele incluir: ( ) Solo una orden ( ) Propósito, contexto y criterios ( ) El nombre de una app
4. ¿Qué dato no debe pegarse sin autorización institucional? ( ) Un texto público ( ) Un nombre y diagnóstico de estudiante ( ) Una definición de IA
...
1 No; 2 Verificarla; 3 Propósito, contexto y criterios; 4 Nombre y diagnóstico; 5 Modelo que se ejecuta en el equipo; 6 El profesional; 7 Minimizar, anonimizar y revisar autorización; 8 Evidencia definida y revisión humana.
